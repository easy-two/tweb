const lang = {
  ...
  'Peer.Activity.Chat.Multi.WatchingLiveStream': '%d watching',
  ...
  'PeerInfo.Action.StreamWith': 'Stream with...',
  'PeerInfo.Action.JoinLiveStream': 'JOIN',
  ...
  'VoiceChat.Chat.LiveStream': 'Live stream',
